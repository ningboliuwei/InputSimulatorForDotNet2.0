...
namespace WindowsInput
{
	...
	public static class InputSimulator
	{
		...
		public static void SimulateModifiedKeyStroke(List<VirtualKeyCode> modifierKeyCodes, VirtualKeyCode keyCode)
		{
			//if (modifierKeyCodes != null) modifierKeyCodes.ToList().ForEach(x => SimulateKeyDown(x));
			//SimulateKeyPress(keyCode);
			//if (modifierKeyCodes != null) modifierKeyCodes.Reverse().ToList().ForEach(x => SimulateKeyUp(x));
		...
		public static void SimulateModifiedKeyStroke(VirtualKeyCode modifierKey, List<VirtualKeyCode> keyCodes)
		{
			SimulateKeyDown(modifierKey);
			//if (keyCodes != null) keyCodes.ToList().ForEach(x => SimulateKeyPress(x));
			...
			if (keyCodes != null)
			{
				...
				{
					SimulateKeyPress(virtualKeyCode);
				}
			}
		...
		#endregion
		public static void SimulateModifiedKeyStroke(List<VirtualKeyCode> modifierKeyCodes, List<VirtualKeyCode> keyCodes)
		{
			//if (modifierKeyCodes != null) modifierKeyCodes.ToList().ForEach(x => SimulateKeyDown(x));
			if (modifierKeyCodes != null)
			{
